...
uv run agent-platform stock-recap --once --mode $MODE --provider $PROVIDER $DATE_ARG --dry-run 2>/dev/null || \
uv run agent-platform stock-recap --once --mode $MODE --provider $PROVIDER $DATE_ARG
```
