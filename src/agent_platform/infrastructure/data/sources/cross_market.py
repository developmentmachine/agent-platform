"""shim → ``agent_platform.agents.stock_recap.data.sources.cross_market`` (W3)
...
_new_mod = _il.import_module("agent_platform.agents.stock_recap.data.sources.cross_market")
