"""shim → ``agent_platform.agents.stock_recap.data.sources.sector_fund_flow`` (W3)
...
_new_mod = _il.import_module("agent_platform.agents.stock_recap.data.sources.sector_fund_flow")
