"""shim → ``agent_platform.agents.stock_recap.data.sources.limit_up_pool`` (W3)
...
_new_mod = _il.import_module("agent_platform.agents.stock_recap.data.sources.limit_up_pool")
