...
from agent_platform.infra.llm.parse import (
    _stable_json,
    parse_and_validate as _parse_and_validate,
    parse_json_from_text,
)
from agent_platform.infra.llm.providers import resolve_provider
from agent_platform.infra.llm.providers._cli_shared import inject_prefetch as _inject_prefetch
from agent_platform.infra.llm.resolve import (
...
logger = logging.getLogger("agent_platform.infra.llm.backends")
