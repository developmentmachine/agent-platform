...
from agent_platform.adapters.http.middleware import install_cors
from agent_platform.adapters.http.v1 import jobs_router, ops_router
    ...
    for defn in registry.list():
        for factory in defn.http_router_factories:
            try:
                ...
                logging.getLogger("agent_platform.adapters.http.app").exception(
